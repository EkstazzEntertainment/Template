namespace Ekstazz.Sounds
{
    ...
    public class SoundSettings : ScriptableObject
    {
        ...
        [SerializeField] private SoundsAvailabilitySettings iosDefaultSettings;
        [SerializeField] private SoundsAvailabilitySettings androidDefaultSettings;
        ...
        [Range(0, 1)] public float masterMusicVolume = 1;
        [Range(0, 1)] public float masterSoundsVolume = 1;
