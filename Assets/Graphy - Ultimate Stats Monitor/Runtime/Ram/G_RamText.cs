...
namespace Tayx.Graphy.Ram
{
    public class G_RamText : MonoBehaviour
    {
        ...
        [SerializeField] private    Text            m_graphicMemorySizeText                 = null;
        ...
        private void Update()
        {
            ...
            if (m_deltaTime > 1f / m_updateRate)
            {
                ...
                m_graphicMemorySizeText         .text = ((int)m_ramMonitor.GraphicRam).ToStringNonAlloc();
        ...
        public void UpdateParameters()
        {
            ...
            m_graphicMemorySizeText         .color = m_graphyManager.GraphicRamColor;
