...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        [SerializeField] private    Color                   m_graphicRamColor                   = new Color(0.2f, 1f, 0.5f, 1);
        ...
        public float MinFPS                             { get { return m_fpsMonitor._80PercentileFPS; } }
        public float MaxFPS                             { get { return m_fpsMonitor._95PercentileFPS; } }
        ...
        public Color GraphicRamColor                    { get { return m_graphicRamColor; } 
                                                          set { m_graphicRamColor = value; m_ramManager.UpdateParameters(); } }
