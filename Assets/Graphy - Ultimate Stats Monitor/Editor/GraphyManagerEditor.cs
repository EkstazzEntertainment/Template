...
namespace Tayx.Graphy
{
    ...
    internal class GraphyManagerEditor : Editor
    {
        ...
        private SerializedProperty m_graphicRamColor;
        ...
        private void OnEnable()
        {
            ...
            m_graphicRamColor = serObj.FindProperty("m_graphicRamColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_ramModuleInspectorToggle)
            {
                ...
                m_graphicRamColor.colorValue = EditorGUILayout.ColorField
                (
                    label: "- Graphic",
                    value: m_graphicRamColor.colorValue
                );
