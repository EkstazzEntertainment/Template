namespace Ekstazz.ProtoGames.Game1.Ui.Windows
{
    using System;
    ...
    public class Game1ReviveWindow : Window<Game1ReviveWindowOptions>
    {
    ...
    public class Game1ReviveWindowOptions : IWindowOptions
    {
